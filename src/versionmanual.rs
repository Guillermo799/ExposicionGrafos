...
// Estructura principal del grafo: representa la red de trenes.
// estaciones: guarda el nombre de cada estación (el índice en este vector es el ID del nodo).
// adyacencia: lista de adyacencia, donde adyacencia[i] contiene los índices
// de todas las estaciones conectadas directamente con la estación i.
struct RedTrenes {
